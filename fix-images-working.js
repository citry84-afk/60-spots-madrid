...
// URLs de Unsplash que SÍ funcionan para cada POI de Madrid
...
if (madridCity) {
  madridCity.pois.forEach(poi => {
    if (madridPOIImages[poi.id]) {
      ...
      console.log(`Updated ${poi.name} with working Unsplash image`);
    }
  });
}
...
console.log('Madrid POI images updated with working Unsplash URLs!');